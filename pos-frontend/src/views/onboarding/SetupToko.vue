...
const bukaSnapMidtrans = (snapToken) => {
	window.snap.pay(snapToken, {
		...
		onClose: function () {
			Swal.fire('Pembayaran Ditunda', 'Silakan selesaikan invoice Anda nanti di halaman manajemen akun.', 'warning').then(() => {
				window.location.href = '/retail/account';
			});
		},
	});
				...
				<form @submit.prevent="submit" class="flex flex-col gap-10">
					<div class="flex flex-col gap-6">
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
							...
							<div class="md:col-span-2">
								<label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-2 block">No. WhatsApp WhatsApp Bisnis</label>
