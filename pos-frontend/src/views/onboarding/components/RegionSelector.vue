...
<template>
	<div class="flex flex-col gap-6 pt-4 border-t border-slate-100">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
			...
			<div class="md:col-span-2">
    <!-- Container Flex untuk Label di Kiri & Button di Kanan -->
    <div class="flex justify-between items-end mb-2">
        <label class="text-[10px] font-black text-indigo-600 uppercase tracking-widest ml-1 flex items-center gap-1">
