...
const fetchCategories = async () => {
    try {
        const response = await api.get('/retail/categories');
...
const submitProduct = async () => {
    ...
    try {
        ...
        const url = isEditing.value 
            ? `${import.meta.env.VITE_API_BASE_URL}/api/retail/products/${editId.value}` 
            : `${import.meta.env.VITE_API_BASE_URL}/api/retail/products`;
