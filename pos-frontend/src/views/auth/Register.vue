...
const handleRegister = async () => {
	...
	try {
		...
		Swal.fire({ 
			...
			text: 'Akun Owner Anda telah tercatat. Silakan lakukan verifikasi kode OTP.', 
		...
		<div class="w-full max-w-2xl relative">
			<div class="bg-white rounded-[40px] p-8 md:p-12 shadow-2xl relative border border-white">
				...
				<div class="text-center mb-10">
					<div class="font-black text-3xl tracking-tighter uppercase cursor-pointer" @click="goHome">NEXA<span class="text-indigo-600">POS</span></div>
