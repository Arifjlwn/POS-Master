...
const handleLogin = async () => {
    ...
    try {
        ...
        localStorage.setItem(
            "storeName",
            data.store_name || "Toko Belum Di-Setup",
        );
        ...
        if (data.has_setup_store === false) {
            ...
            if (tipeBisnis.includes("laundry")) {
                router.push(
                    roleUser === "owner" ? "/laundry/laporan" : "/laundry/pos",
                );
                ...
                tipeBisnis.includes("salon") ||
                tipeBisnis.includes("barbershop")
            ) {
                router.push(
                    roleUser === "owner" ? "/salon/dashboard" : "/salon/pos",
                );
            } else if (tipeBisnis.includes("cuci")) {
                router.push(
                    roleUser === "owner"
                        ? "/cuci-kendaraan/dashboard"
                        : "/cuci-kendaraan/pos",
                );
            } else if (
                tipeBisnis.includes("f&b") ||
                tipeBisnis.includes("food")
            ) {
                router.push(
                    roleUser === "owner" ? "/fnb/laporan" : "/fnb/kasir",
                );
            } else {
...
<template>
    <div
        class="min-h-screen flex items-center justify-center bg-[#F8FAFC] font-sans p-4 relative overflow-hidden"
    >
        <div
            class="absolute -top-24 -left-24 w-96 h-96 bg-blue-100/50 rounded-full blur-3xl"
        ></div>
        <div
            class="absolute -bottom-24 -right-24 w-96 h-96 bg-indigo-100/50 rounded-full blur-3xl"
        ></div>

        <div class="w-full max-w-md relative group mt-10 md:mt-0 z-10">
            <div
                class="absolute -inset-1 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-[40px] blur opacity-20 group-hover:opacity-30 transition duration-1000"
            ></div>

            <div
                class="bg-white rounded-[40px] p-8 md:p-12 shadow-2xl relative border border-white flex flex-col"
            >
                <div class="text-center mb-10 relative">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-3xl shadow-xl shadow-blue-200 mb-6 transform -rotate-6 group-hover:rotate-0 transition-transform duration-500"
                    >
                        <svg
                    ...
                    <p
                        class="text-slate-400 font-bold text-[10px] uppercase tracking-[0.3em] mt-2"
                    >
                        ...
                        <div class="relative group">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <path
                                        d="M13.41 13.41a2 2 0 0 1-2.82-2.82"
                                    />
                                </svg>
                            </button>
                        </div>
                ...
                <div class="mt-8 text-center">
                    <p
                        class="text-[9px] font-black text-slate-300 uppercase tracking-[0.4em]"
                    >
                        Integrated Business Intelligence &copy; 2026
                    </p>
                </div>
            </div>
        </div>
