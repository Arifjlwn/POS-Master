...
const pricingPlans = {
    retail: [
        ...
        },
        {
            ...
            price: '49k',
            duration: '/Bulan',
            desc: 'Solusi solid untuk toko kelontong dengan 1 titik kasir.',
        ...
        },
        {
            ...
            price: '149k',
            duration: '/Bulan',
            desc: 'Cocok untuk minimarket yang mulai mengelola karyawan.',
            features: ['Semua Fitur Basic', 'Manajemen Hak Akses Kasir', 'Smart Attendance & Shift', 'Laporan Ekspor (Excel/PDF)']
        },
        {
            id: 'premium',
            name: 'Retail Premium',
            price: '299k',
            duration: '/Bulan',
            desc: 'Kendali penuh untuk bisnis multi-cabang & gudang.',
            features: ['Semua Fitur Pro', 'Sistem Multi-Cabang (HO)', 'Manajemen Multi-Gudang', 'Dedicated Support 24/7']
        }
    ],
    fnb: [
        {
            ...
            features: ['POS Kasir F&B', 'Manajemen Menu & Kategori', 'Hold/Simpan Pesanan', 'Tanpa Kartun Kredit']
        },
        {
            id: 'basic',
            name: 'F&B Basic',
        ...
        },
        {
            ...
            price: '169k',
            duration: '/Bulan',
            desc: 'Untuk restoran sibuk dengan kontrol bahan baku ketat.',
            features: ['Semua Fitur Basic', 'Resep Bahan Baku (BOM)', 'Split Bill & Gabung Meja', 'Smart Attendance & Shift']
        },
        {
            id: 'premium',
            name: 'F&B Premium',
            ...
            features: ['Semua Fitur Pro', 'Manajemen Franchise/Cabang', 'Self-Order QR Menu', 'Dedicated Support 24/7']
        }
    ],
    jasa: [
        {
        ...
        },
        {
            ...
            price: '159k',
            duration: '/Bulan',
            desc: 'Sistem otomatisasi notifikasi dan komisi karyawan.',
            features: ['Semua Fitur Basic', 'Bagi Hasil / Komisi Karyawan', 'Notif WA Otomatis (Selesai)', 'Smart Attendance & Shift']
        },
        {
            id: 'premium',
            ...
            price: '329k',
            duration: '/Bulan',
            desc: 'Manajemen loyalitas pelanggan dan penjadwalan tingkat lanjut.',
            features: ['Semua Fitur Pro', 'Sistem Booking & Reservasi', 'Sistem Poin Loyalty', 'Manajemen Multi-Cabang']
        }
    ]
};
    ...
    <div class="min-h-screen bg-[#F8FAFC] font-sans text-slate-900 selection:bg-indigo-100 selection:text-indigo-600 overflow-x-hidden antialiased">
        ...
        <nav
            :class="[
                ...
                isScrolled ? 'bg-white/80 backdrop-blur-xl border-b border-slate-200/60 py-4 shadow-md shadow-slate-100/50' : 'bg-transparent py-6'
            ]">
            <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center gap-10">
                    <button
                        @click="scrollToSection('industri')"
                        class="text-xs font-black uppercase tracking-widest text-slate-500 hover:text-indigo-600 transition-colors">
                        Solusi
                    </button>
                    <button
                    ...
                    <router-link
                        to="/login"
                        class="text-xs font-black uppercase tracking-widest text-slate-800 hover:text-indigo-600 transition-colors ml-4 border-l pl-4 border-slate-200">
                        Masuk
                    </router-link>
                    <button
                        @click="scrollToSection('pricing')"
                        class="bg-slate-900 text-white text-[10px] font-black uppercase tracking-[0.2em] px-7 py-3.5 rounded-full hover:bg-indigo-600 shadow-xl hover:shadow-indigo-200/50 transition-all active:scale-95 duration-300">
                        Mulai Trial
                    </button>
                </div>
                ...
                <button
                    ...
                    class="md:hidden p-2 text-slate-600 hover:text-indigo-600 transition-colors focus:outline-none">
                    <svg
                        v-if="!isMenuOpen"
            ...
            <transition name="fade">
                <div
                    v-show="isMenuOpen"
                    class="md:hidden absolute top-full left-0 w-full bg-white/95 backdrop-blur-xl border-b border-slate-200/80 shadow-2xl flex flex-col py-6 px-6 gap-4 animate-[fadeIn_0.2s_ease-out]">
                    <button
                        @click="scrollToSection('industri')"
                        class="text-left text-sm font-black uppercase tracking-widest text-slate-600 py-3 border-b border-slate-100">
                        Solusi Industri
                    </button>
                    <button
                        @click="scrollToSection('features')"
                    ...
                    <router-link to="/login" class="text-sm font-black uppercase tracking-widest text-slate-700 py-3 border-b border-slate-100">
                        Portal Log In
                    </router-link>
                    <button
                        @click="scrollToSection('pricing')"
                        class="w-full text-center bg-indigo-600 text-white text-xs font-black uppercase tracking-[0.2em] px-6 py-4 rounded-2xl mt-2 shadow-lg shadow-indigo-100">
                        Mulai Trial Gratis
                    </button>
                </div>
            </transition>
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-12">
                <div class="flex-1 text-center lg:text-left">
                    <div class="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200/80 rounded-full mb-8 shadow-sm">
                        ...
                        <span class="text-[9px] md:text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">
                            Infrastruktur SaaS Skala Premium
                        </span>
                    </div>
                    ...
                    <p class="max-w-xl mx-auto lg:mx-0 text-slate-500 font-bold text-base md:text-lg mb-12 leading-relaxed">
                        Tinggalkan cara konvensional. Kendalikan transaksi kasir, manajemen rantai pasok, hingga analitik performa cabang secara
                        real-time dari satu dashboard operasional terpusat.
                    </p>

                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
                        <button
                            @click="scrollToSection('pricing')"
                            class="w-full sm:w-auto bg-indigo-600 text-white px-10 py-5 rounded-2xl font-black text-xs md:text-sm uppercase tracking-widest shadow-2xl shadow-indigo-200/80 hover:bg-slate-900 transition-all duration-300 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2">
                            Lihat Paket Harga
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-5 h-5"
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2 sm:mt-0">
                            Proses Setup Instan &lt; 2 Menit
                        </span>
                    </div>
                </div>
                ...
                <div class="flex-1 w-full max-w-lg lg:max-w-none relative">
                    <svg class="absolute -top-10 -left-10 w-32 h-32 text-slate-200/70" fill="currentColor" viewBox="0 0 100 100">
                    ...
                    <div
                        class="relative bg-white p-8 md:p-10 rounded-[40px] shadow-2xl shadow-indigo-900/5 border border-white/80 z-10 transform hover:-translate-y-2 transition-transform duration-500">
                        <div class="flex items-center justify-between mb-8 pb-6 border-b border-slate-100">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center text-white shadow-lg shadow-indigo-200">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="w-7 h-7"
                                        viewBox="0 0 24 24"
                                ...
                                <div>
                                    <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">
                                        Live Revenue (All Branches)
                                    </div>
                                    <div class="text-3xl font-black text-slate-800 tracking-tighter">Rp 24.580.000</div>
                                </div>
                            </div>
                            <span
                                class="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-1 border border-emerald-100">
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center text-xs font-black text-slate-400 uppercase tracking-wider mb-2">
                            ...
                            <div class="flex items-center justify-between p-4 bg-slate-50/80 rounded-2xl border border-slate-100">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-black text-slate-700">Sinkronisasi Multi-Gudang</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-slate-50/80 rounded-2xl border border-slate-100">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-black text-slate-700">Backup Cloud Server</span>
                                </div>
        ...
        <section id="industri" class="py-28 bg-slate-900 text-white relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="text-center mb-20">
                    <h2 class="text-4xl md:text-5xl font-black tracking-tighter mb-5 uppercase">
                        Arsitektur Modular
                        <br />
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400">Sesuai Model Bisnis</span>
                    </h2>
                    <p class="text-slate-400 font-bold text-xs md:text-sm uppercase tracking-[0.2em] max-w-2xl mx-auto leading-relaxed">
                        Kami tidak menggunakan sistem "Pukul Rata". Setiap industri mendapatkan modul spesifik yang otomatis dikonfigurasi saat
                        pendaftaran bisnis Anda.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div
                        ...
                        <div
                            class="w-16 h-16 rounded-2xl bg-slate-800 text-indigo-400 flex items-center justify-center border border-slate-700/60 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 group-hover:scale-110 shadow-inner">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-7 h-7"
                                viewBox="0 0 24 24"
                        ...
                        <div>
                            <h4 class="font-black text-xl uppercase tracking-wider text-white mb-3">
                                {{ ind.title }}
                            </h4>
                        ...
                        <div
                            class="mt-auto pt-6 w-full flex items-center justify-between text-indigo-400 text-xs font-black uppercase tracking-widest group-hover:text-indigo-300 border-t border-slate-800/60">
                            Lihat Paket Harga
                            <svg
        ...
        <section id="features" class="py-28 bg-white relative border-t border-slate-100">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-24">
                    <h2 class="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter mb-5 uppercase">
                        Teknologi
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-600">Terdepan</span>
                    </h2>
                    <p class="text-slate-400 font-bold text-xs md:text-sm uppercase tracking-[0.2em]">
                        Infrastruktur tangguh penopang efisiensi operasional harian Anda.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div
                        ...
                        :key="feat.title"
                        class="bg-[#F8FAFC]/60 p-8 rounded-[32px] border border-slate-200/60 hover:shadow-2xl hover:shadow-indigo-900/5 transition-all duration-300 group hover:-translate-y-2 flex flex-col">
                        <div
                            class="w-14 h-14 bg-white border border-slate-200 text-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-indigo-600 group-hover:border-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm"
                            v-html="feat.icon"></div>
                        <h3 class="text-lg font-black text-slate-800 mb-3 tracking-tight uppercase">
                            {{ feat.title }}
                        </h3>
        ...
        <section id="pricing" class="py-32 bg-[#f8fafc] border-t border-slate-200/60 relative overflow-hidden">
            ...
            <div
                class="absolute top-1/4 left-1/2 -translate-x-1/2 w-[60rem] h-[60rem] bg-indigo-50/50 rounded-full blur-3xl pointer-events-none"></div>

            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter mb-5 uppercase">
                        Investasi
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-600">Transparan</span>
                    </h2>
                    <p class="text-slate-400 font-bold text-xs md:text-sm uppercase tracking-[0.2em] max-w-2xl mx-auto leading-relaxed">
                ...
                <div class="w-full flex justify-center mb-24 px-4">
                    <div
                        class="bg-white/80 backdrop-blur-md p-1.5 rounded-[24px] border border-slate-200/80 flex w-full max-w-xl shadow-xl shadow-slate-100">
                        <button
                            v-for="ind in industries"
                            :key="ind.id"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
                    <div
                        ...
                        <div
                            v-if="plan.id === 'pro'"
                            class="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-5 py-2 rounded-full text-[9px] font-black uppercase tracking-widest shadow-xl shadow-indigo-200 whitespace-nowrap animate-pulse">
                            🔥 Rekomendasi UMKM
                        </div>
                        ...
                        <div
                            ...
                            class="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 px-5 py-2 rounded-full text-[9px] font-black uppercase tracking-widest shadow-xl shadow-amber-500/20 whitespace-nowrap">
                            👑 Fitur Dewa (HO)
                        </div>
                        ...
                        <!-- Tombol CTA Dinamis -->
                        <router-link
                            :to="`/register?industry=${activePricingTab}&plan=${plan.id}`"
                            :class="[
                                ...
                                plan.id === 'pro'
                                    ? 'bg-gradient-to-r from-indigo-600 to-blue-600 text-white hover:from-slate-900 hover:to-slate-900 shadow-xl shadow-indigo-200'
                                    : '',
                                plan.id === 'premium'
                                    ? 'bg-gradient-to-r from-amber-400 to-amber-500 text-slate-950 font-extrabold hover:from-white hover:to-white shadow-xl shadow-amber-950/50'
                                    : ''
                            ]"
        ...
        <section class="py-24 bg-[#F8FAFC]">
            <div class="max-w-5xl mx-auto px-6">
                <div
                    class="bg-gradient-to-br from-indigo-950 via-slate-900 to-black rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <div class="relative z-10">
                        ...
                        <button
                            @click="scrollToSection('pricing')"
                            class="inline-flex items-center gap-3 bg-white text-slate-900 px-10 py-5 rounded-full font-black text-xs md:text-sm uppercase tracking-widest hover:bg-indigo-50 hover:shadow-2xl transition-all duration-300 active:scale-95 shadow-xl mt-4">
                        ...
                        <div
                            class="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-indigo-200 text-[10px] font-black uppercase tracking-widest">
                            <span class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                                </svg>
                                Gratis Registrasi Sistem
                            </span>
        ...
        <footer class="py-14 bg-white border-t border-slate-200/60">
            <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                ...
                <div class="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] md:order-2">&copy; 2026 Developed by Arif Juliawan</div>

                <div class="flex gap-8 justify-center md:order-3">
                    <a href="#" class="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-colors">
                        Term of Service
                    </a>
                    <a href="#" class="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-colors">
                        Privacy Policy
