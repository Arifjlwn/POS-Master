...
import { useRouter } from 'vue-router'; // <-- Pakai router murni Vue, bukan Inertia
...
// Eksekusi ke database API Golang
...
<template>
    <div class="p-4 md:p-6 bg-gray-50 min-h-screen">
        <div class="bg-blue-800 text-white rounded-xl shadow-md mb-6 flex flex-col md:flex-row overflow-hidden border border-blue-900">
            <div @click="goToDashboard" class="p-3 px-5 bg-blue-900 md:w-1/4 flex flex-col justify-center cursor-pointer hover:bg-blue-950 transition-colors">
                <div class="font-black text-lg tracking-wider text-blue-50 text-center flex items-center justify-center gap-2">
                    <span>⬅️</span> POS KASIR
                </div>
                <div class="text-center text-[10px] text-blue-300 uppercase mt-0.5 tracking-widest font-semibold">
            ...
            <div class="flex-1 flex flex-col justify-between border-r border-blue-700">
                ...
                <div class="flex justify-between items-center px-4 py-2 bg-blue-800">
                    <div class="text-xs md:text-sm font-semibold text-blue-100 flex gap-3 md:gap-6">
                        ...
                        <span class="flex items-center gap-1">
                            <span class="opacity-70">Shift:</span> 1
                        </span>
                        <span class="flex items-center gap-1">
                            <span class="opacity-70">Station:</span> 01
                        </span>
                    </div>
            ...
            <div class="w-full lg:w-8/12 flex flex-col">
                <div class="mb-5 relative group">
                    ...
                    <input
                        ...
                        class="w-full pl-12 pr-4 py-3.5 rounded-2xl border border-gray-200 shadow-sm focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 text-gray-800 font-bold bg-white text-lg transition-all outline-none"
                    >
                </div>
                            ...
                            <div class="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-200">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        class="w-36 text-right text-base font-black rounded-lg py-1.5 pl-8 pr-3 transition-all shadow-sm outline-none"
                                        placeholder="0">
                                </div>
                            </div>
            ...
            <div class="bg-gray-200 p-4 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden border-t-8 border-gray-800">
                <div id="print-area" class="text-left font-mono text-[11px] leading-tight uppercase text-black bg-white p-4 mx-auto" style="width: 58mm;">
                    ...
                    <div class="mb-2 text-[10px] font-bold">
                        <p>{{ lastTransaction?.date }} / KASIR / 01</p>
                    </div>
