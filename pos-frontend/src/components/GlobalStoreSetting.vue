...
import SettingBasicInfo from './setting-store/SettingBasicInfo.vue';
import SettingPayment from './setting-store/SettingPayment.vue';
import SettingReceiptTax from './setting-store/SettingReceiptTax.vue';
