<script setup>
import { useManageKaryawan } from '../../composables/useManageKaryawan.js';
import Sidebar from '../../components/Sidebar.vue';

import EmployeeHeader from '../../components/employee/EmployeeHeader.vue';
import EmployeeListMobile from '../../components/employee/EmployeeListMobile.vue';
import EmployeeTableDesktop from '../../components/employee/EmployeeTableDesktop.vue';
        ...
        <div class="p-4 md:p-8 lg:p-10 max-w-7xl mx-auto font-sans bg-[#f8fafc] min-h-screen">
            ...
            <div v-else>
                <EmployeeListMobile 
                    ...
                    :hitungMasaKerja="hitungMasaKerja"
                    @edit="openEditModal"
            ...
            <EmployeeFormModal 
                ...
                @update-biometric="handleUpdateBiometric"
            />
