...
const loadingPayment = ref(false); // Buat loading add-on kasir
    ...
    <Sidebar>
        ...
        >
            ...
            >
                ...
                >
                    Operasional sistem POS dihentikan sementara.<br />Silakan
                    perpanjang paket untuk membuka kembali akses toko Anda.
                </p>
            </div>

            <div
                class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full mb-20"
            >
                <div
                ...
                >
                    ...
                    <h3 class="text-2xl font-black text-white uppercase mb-3">
                        Basic
                    </h3>
                    <div class="flex items-baseline justify-center gap-1 mb-6">
                        ...
                        ><span class="text-5xl font-black text-white"
                            >49<span class="text-lg text-slate-500"
                                >k</span
                            ></span
                        >
                    </div>
                ...
                >
                    ...
                    <div class="flex items-baseline justify-center gap-1 mb-6">
                        <span class="text-sm font-black text-slate-400">Rp</span
                        ><span class="text-5xl font-black text-white"
                            >149<span class="text-lg text-slate-500"
                                >k</span
                            ></span
                        >
                    </div>
                ...
                >
                    ...
                    <div class="flex items-baseline justify-center gap-1 mb-6">
                        <span class="text-sm font-black text-slate-400">Rp</span
                        ><span class="text-5xl font-black text-white"
                            >299<span class="text-lg text-slate-500"
                                >k</span
                            ></span
                        >
                    </div>
                            ...
                            >
                                ...
                                >
                                    <p class="font-bold text-slate-500 text-xs">
                                        Masa aktif berlangganan Anda sampai
                                        dengan:
                                    </p>
                                    <p
                                        class="text-lg font-black text-indigo-600 mt-1"
                                    >
                                        {{ subEnd }}
                                    </p>
                                </div>
                                    ...
                                    >
                                        <div>
                                            ...
                                            >
                                                ...
                                                (HP/Tablet/PC) yang bisa membuka
                                                laci kasir secara bersamaan.
                                            </p>
                                            <div
                ...
                <div class="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-1">
                    ...
                    >
                        ...
                        >
                            ...
                            <h3
                                class="text-xl font-black text-slate-800 uppercase mb-3"
                            >
                                Trial 14 Hari
                            </h3>
                            <p
                            ...
                            >
                                Validasi kesesuaian sistem dengan ekosistem
                                bisnis Anda.
                            </p>
                        ...
                        >
                            ...
                            <p
                                class="text-[11px] font-bold text-slate-500 mb-5 min-h-[35px] leading-relaxed"
                            >
                                Solusi solid untuk toko kelontong dengan 1 titik
                                kasir.
                            </p>
                            <div class="flex items-baseline gap-1 mb-6">
                                ...
                                <span class="text-4xl font-black text-slate-800"
                                    >49<span class="text-base text-slate-500"
                                        >k</span
                                    ></span
                                >
                                <span
                        ...
                        >
                            ...
                            <p
                                class="text-[11px] font-bold text-slate-500 mb-5 min-h-[35px] leading-relaxed"
                            >
                                Cocok untuk minimarket yang mulai mengelola
                                karyawan.
                            </p>
                            <div class="flex items-baseline gap-1 mb-6">
                                <span class="text-sm font-black text-slate-400"
                                ...
                                >
                                <span class="text-4xl font-black text-slate-800"
                                    >149<span class="text-base text-slate-500"
                                        >k</span
                                    ></span
                                >
                                <span
                        ...
                        >
                            ...
                            <h3
                                class="text-xl font-black text-white uppercase mb-3"
                            >
                                Premium
                            </h3>
                            <p
                            ...
                            >
                                Kendali penuh untuk bisnis multi-cabang &
                                gudang.
                            </p>
                            <div class="flex items-baseline gap-1 mb-6">
                                <span class="text-sm font-black text-slate-400"
                                ...
                                <span class="text-4xl font-black text-white"
                                    >299<span class="text-base text-slate-400"
                                        >k</span
                                    ></span
                                >
                                <span
