        ...
        <div v-if="!isExpired" class="p-4 md:p-8 lg:p-10 max-w-5xl mx-auto font-sans bg-[#f8fafc] min-h-screen">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-[10px] md:text-xs font-black text-slate-400 uppercase tracking-widest mt-1">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-4 flex items-end gap-1">
                                                ...
                                                <span class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest pb-1">
                ...
                <div class="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white rounded-[24px] p-6 border border-slate-200 flex flex-col relative">
                            ...
                            <p class="text-[11px] font-bold text-slate-500 mb-5 min-h-[35px] leading-relaxed">
                        ...
                        <div class="bg-slate-900 rounded-[24px] p-6 border border-slate-700 flex flex-col">
                            ...
                            <p class="text-[11px] font-bold text-slate-400 mb-5 min-h-[35px] leading-relaxed">
