...
// 🚀 Hubungkan ke sirkuit otak Composable yang utuh di atas
const {
...
// DOM logic khusus cetak media print thermal kasir
...
<template>
    <div class="h-[100dvh] flex flex-col bg-slate-100 font-sans overflow-hidden">
        ...
        <div v-if="showClosingModal" class="fixed inset-0 bg-slate-900/90 flex items-center justify-center z-[160] p-4 backdrop-blur-sm">
