...
<template>
    <div class="min-h-screen bg-slate-955 flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-blue-100">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <button v-for="n in ['01', '02', '03']" :key="n" 
                                ...
                                :class="stationNumber === n ? 'bg-slate-900 text-white shadow-xl shadow-slate-200 scale-105 border-slate-900' : 'bg-slate-50 text-slate-400 grayscale border-transparent'"
                                class="flex flex-col items-center gap-2 py-4 rounded-[28px] border-2 transition-all duration-300 outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect width="18" height="12" x="3" y="4" rx="2" ry="2"/><line x1="2" x2="22" y1="20" y2="20"/><line x1="12" x2="12" y1="16" y2="20"/></svg>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative group">
                            <div class="absolute left-6 top-1/2 -translate-y-1/2 flex flex-col items-center select-none pointer-events-none">
                    ...
                    <div class="pt-4">
                        <button @click="handleBukaKasir" :disabled="loading"
                            ...
                            <span>{{ loading ? 'Accessing Server...' : 'Initialize Session' }}</span>
                            <svg v-if="!loading" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                        </button>
                        
                        <div class="mt-8 text-center" v-if="role === 'owner'">
                            <button @click="router.push('/retail/dashboard')" 
