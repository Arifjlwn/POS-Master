...
export function useAbsensi() {
    ...
    // 🚀 BINDING VIDEO REF DARI COMPONENT ANAK
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [resRiwayat, resSched] = await Promise.all([
                ...
                api.get('/retail/schedules', { params: { 
    ...
    const downloadLaporan = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/retail/attendance/export?bulan=${bulan}&tahun=${tahun}`, {
    ...
    return {
        currentTime, karyawan, riwayat, urutanTanggalTerbaru, isLoading, filterMode, bulanDipilih,
        isAiLoading, toggleSortTanggal, currentUser, tanggalDipilih, showCameraModal, absenTarget, 
        isSubmitting, me, setVideoRef, fetchData, lihatFoto, mulaiAbsen, stopCamera, jepretDanKirim, downloadLaporan
    };
}