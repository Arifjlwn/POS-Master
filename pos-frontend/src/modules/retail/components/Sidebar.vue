        ...
        <header
            ...
            <div class="flex items-center gap-4 sm:gap-5">
                ...
                <div class="flex items-center gap-3">
                    <img
                        v-if="user.storeLogo && user.storeLogo !== 'null' && user.storeLogo !== ''"
                        :src="user.storeLogo"
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-3 sm:pl-4 sm:border-l border-slate-100">
                    <div class="text-right hidden sm:block">
                        <div class="text-xs font-black text-slate-800 uppercase leading-none">
                            {{ user.name.split(' ')[0] }}
                        </div>
                        <span
                    ...
                    <div
                        ...
                        <img
                            v-if="user.foto_url && user.foto_url !== 'null' && user.foto_url !== ''"
                            :src="user.foto_url"
                ...
                <div>
                    ...
                    <div class="space-y-1.5">
                        <router-link
                            ...
                            <svg class="icon group-hover:-rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <router-link
                            ...
                            <svg class="icon group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    stroke-width="2.5"
                        ...
                        <router-link
                            ...
                            <svg class="icon group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                        ...
                        <router-link
                            ...
                            <svg class="icon group-hover:rotate-45" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    stroke-width="2.5"
                ...
                <div>
                    ...
                    <div v-show="openGroups.stock" class="mt-2 space-y-1 ml-4 border-l-2 border-slate-100 pl-2">
                        ...
                        <router-link
                            ...
                            @click="sidebarOpen = false"
                            class="sub-link hover:text-emerald-600 hover:bg-emerald-50 hover:border-emerald-500"
                            :class="{ 'active-sub !text-emerald-700 !bg-emerald-50/80 !border-emerald-500': route.path === '/retail/stock-opname' }">
                            Stock Opname
                        </router-link>
                        ...
                        <router-link
                            ...
                            :class="{
                                'active-sub !text-rose-700 !bg-rose-50/80 !border-rose-500': route.path.startsWith('/retail/produk/retur-barang')
                            }">
                            Waste & Retur
                        </router-link>
                    </div>
                    ...
                    <div v-show="openGroups.admin" class="mt-2 space-y-1 ml-4 border-l-2 border-slate-100 pl-2">
                        <template v-if="user.role === 'owner'">
                            ...
                            <router-link
                                ...
                                :class="{ 'active-sub !text-amber-700 !bg-amber-50/80 !border-amber-500': route.path === '/retail/dashboard' }">
                                Dashboard Analitik
                            </router-link>
                            ...
                            <router-link
                                ...
                                @click="sidebarOpen = false"
                                class="sub-link hover:text-amber-600 hover:bg-amber-50 hover:border-amber-500"
                                :class="{ 'active-sub !text-amber-700 !bg-amber-50/80 !border-amber-500': route.path === '/retail/sdm/karyawan' }">
                                Manajemen Karyawan
                            </router-link>
                        </template>
                        ...
                        <router-link
                            ...
                            @click="sidebarOpen = false"
                            class="sub-link hover:text-amber-600 hover:bg-amber-50 hover:border-amber-500"
                            :class="{ 'active-sub !text-amber-700 !bg-amber-50/80 !border-amber-500': route.path === '/retail/stock-opname/report' }">
                            Laporan Hasil SO
                        </router-link>
                        <a v-if="planLevel < 3" href="#" @click.prevent="triggerUpgrade('Laporan Audit Lanjutan', 3)" class="sub-link-locked">
                        ...
                        <router-link
                            ...
                            class="sub-link hover:text-amber-600 hover:bg-amber-50 hover:border-amber-500"
                            :class="{
                                'active-sub !text-amber-700 !bg-amber-50/80 !border-amber-500': route.path === '/retail/produk/retur-barang/report'
                            }">
                    ...
                    <div class="space-y-1.5">
                        <template v-if="user.role === 'owner'">
                            <a
                                v-if="planLevel < 3"
                                href="#"
                                @click.prevent="triggerUpgrade('Integrasi WhatsApp Notifier', 3)"
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col max-w-[100px] sm:max-w-[120px]">
                            <div class="text-xs font-black text-slate-800 uppercase leading-none truncate">
                                {{ user.name }}
                            </div>
