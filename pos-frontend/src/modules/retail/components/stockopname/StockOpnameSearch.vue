...
<template>
    <div class="bg-white p-6 rounded-[32px] shadow-sm border border-slate-100 relative">
        <div class="flex items-center gap-3">
            ...
            <button @click="$emit('scan')" :disabled="disabled" class="shrink-0 p-5 bg-indigo-50 hover:bg-indigo-600 text-indigo-600 hover:text-white rounded-[24px] transition-all border border-indigo-100 shadow-sm" title="Scan Barcode">
