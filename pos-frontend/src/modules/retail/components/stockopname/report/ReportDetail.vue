...
<template>
            ...
            <div class="relative z-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4 border-b-2 border-slate-800 pb-6 mb-6">
                    <div class="text-center sm:text-left">
                        <h1 class="text-2xl font-black text-slate-900 uppercase tracking-[0.2em] leading-tight">
                        ...
                        <div class="mt-3 flex gap-2 flex-wrap justify-center sm:justify-start">
                            ...
                            <span v-if="detail.klaim" class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border"
                ...
                <div class="mb-8 p-6 rounded-2xl border-2 border-solid" :class="finalNetto < 0 ? 'bg-red-50 border-red-200' : 'bg-emerald-50 border-emerald-200'">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div class="text-center md:text-right">
                            ...
                            <div class="text-3xl font-black" :class="finalNetto < 0 ? 'text-red-600' : 'text-emerald-600'">
    ...
    <h4 class="font-black text-slate-800 text-[10px] uppercase tracking-[0.2em] mb-4 mt-10 flex items-center gap-2">
        <span class="w-1.5 h-4 bg-slate-800 rounded-full"></span> 3. Otorisasi & Pengesahan Laporan
    </h4>
...
@media print {
    ...
    /* 1. JANGAN matikan #app atau html bray! Biarkan mereka hidup sebagai wrapper */
    html, body {
    ...
    /* 3. Paksa area pembungkus luar grid melonggarkan diri jadi full width bray */
    .grid, .max-w-7xl, #stock-opname-view, .lg\:col-span-8 {
    ...
    /* 4. Cabut paksa #print-area dari layout flexbox induk dan jadikan penguasa tunggal kertas cetak bray! */
    #print-area {
        display: block !important;
    ...
    /* 5. Kalibrasi ketebalan border tabel laci kasir bray */
    .print-table {
    ...
    .border-b-2, .border-t-2, .border-2 { 
