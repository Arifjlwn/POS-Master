						...
						<td class="p-5 flex items-center gap-4">
							...
							<div>
								...
								<div class="flex flex-wrap items-center gap-2 mt-1.5">
									...
									<span v-if="product.satuan_besar" class="text-[8px] md:text-[9px] font-black bg-purple-50 text-purple-600 px-2 py-0.5 rounded border border-purple-100 uppercase tracking-widest" title="Isi Konversi">1 {{ product.satuan_besar }} = {{ Number(product.isi_per_besar || 0).toLocaleString('id-ID') }} {{ product.satuan_dasar || 'PCS' }}</span>
								</div>
							</div>
						</td>
