...
<template>
	<div class="p-4 sm:p-6 lg:p-8 bg-[#0B0F19] min-h-screen text-white font-sans overflow-x-hidden">
		...
		<SaaSRevenueCards :mrr="telemetry.mrr" :arr="telemetry.arr" :total-tenants="telemetry.total_tenants" :new-tenants="telemetry.new_tenants" :formatRupiah="formatRupiah" />

		<SaaSChartGrid :telemetry="telemetry" />

		<WhaleTenantTable :top-tenants="telemetry.top_tenants" :formatRupiah="formatRupiah" />
	</div>
</template>
