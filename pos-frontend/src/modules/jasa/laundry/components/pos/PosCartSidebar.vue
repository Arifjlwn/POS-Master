        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar bg-slate-50/50 flex flex-col">
            <div class="p-4 border-b border-slate-200 bg-white flex flex-col gap-4 shadow-sm relative z-10 shrink-0">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        <div class="flex items-end justify-between mb-1.5 ml-0.5">
                            <label class="block text-[9px] font-black text-slate-400 uppercase tracking-widest">Estimasi Selesai</label>
                            <span v-if="cart.length > 0" class="text-[8px] font-black text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded uppercase tracking-widest border border-indigo-100 animate-pulse">Auto Hitung ⚡</span>
                        </div>
