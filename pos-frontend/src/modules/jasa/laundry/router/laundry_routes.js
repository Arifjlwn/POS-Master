...
export default [
    ...
    },
    {
        ...
        name: "LaundryRiwayat",
        component: () => import("../views/pos/RiwayatLaundry.vue"), // Pastikan rute riwayat transaksi lu aman bray
        meta: { requiresAuth: true, minPlanLevel: 1 },
    },
    {
        path: "/laundry/status",
        name: "LaundryStatus",
        component: () => import("../views/StatusCucian.vue"), // Tracker rak / antrean pakaian pelanggan
        meta: { requiresAuth: true, minPlanLevel: 1 },
    },
