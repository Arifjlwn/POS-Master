...
func (h *RetailHandler) OpenSession(c *gin.Context) {
	...
	// 🛡️ SATPAM 1: Cek Anti-Double Login Diri Sendiri
	...
	// 🚀 🛡️ SATPAM 2: CEK KUOTA TERMINAL LACI KASIR CABANG INI
	...
	if kuotaTerminal == 0 {
		kuotaTerminal = 1 // Default jatah 1 kasir
	}

	// 🚀 JEPRET! KALO PENUH, KIRIM KODE "QUOTA_FULL" KE VUE!
	if activeSessions >= int64(kuotaTerminal) {
		c.JSON(http.StatusForbidden, gin.H{
			"error_code": "QUOTA_FULL", // 👈 INI YANG DITUNGGUIN SAMA VUE LU!
			"error":      "Batas Terminal Kasir Tercapai! Ada kasir lain yang sedang buka shift. Silakan tutup shift sebelumnya atau Beli Lisensi Tambahan.",
		})
		return
	}
